...
for (var i = 0; i < issue.length; i++) {
    ...
    $('#bricks').append('<div class="issue">' + '<div class="l-issue">' + '<p class="type">' + "ISSUE" + '</p>' + '<p class="address-date">' + issue[i].address + '</p>' + '<p class="info">' + issue[i].issue_type + '</p>' + '<p class="info">' + issue[i].issue_description + '</p>' + '<p class="address-date">' + date + '</p>' + '</div>' + '<img src="camera.svg" class="camera">' + '</div>');
